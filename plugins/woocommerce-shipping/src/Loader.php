...
class Loader {
	...
	public function pre_wc_init() {
		...
		$this->init_rest_endpoints_for_dynamic_request();
	...
	public function should_show_shipment_tracking_meta_box() {
		return ! Integrations\WooCommerceShipmentTracking::is_st_installed();
	}
	...
	/**
	 * Loads the REST API endpoints for dynamic requests like request from the WC Core to install the plugin.
	 * This is added to avoid _doing_it_wrong invocation in documented in register_rest_route.
	 *
	 * @see https://developer.wordpress.org/reference/functions/register_rest_route/
	 *
	 * @return void
	 */
	private function init_rest_endpoints_for_dynamic_request() {
		if ( wp_doing_ajax() ) {
			$this->tos_rest_init();
			$this->rest_api_init();
		}
