jQuery(document).ready(function ($) {
	...
	$('#TPRM_importer_email_option_upload_button,#TPRM_importer_email_template_upload_button').click(function (e) {
		var btn = e.target;
	...
	$('#enable_email_templates').change(function () {
		...
		var data = {
			'action': 'TPRM_importer_refresh_enable_email_templates',
			'enable': enable,
	...
	$('#load_email_template').click(function () {
		...
		var data = {
			'action': 'TPRM_importer_email_template_selected',
