...
add_filter( 'TPRM_importer_restricted_fields', 'TPRM_importer_wpug_restricted_fields', 10, 1 );
add_action( 'TPRM_importer_documentation_after_plugins_activated', 'TPRM_importer_wpug_documentation_after_plugins_activated' );
add_action( 'post_TPRM_importer_import_single_user', 'TPRM_importer_wpug_post_import_single_user', 10, 3 );

function TPRM_importer_wpug_restricted_fields( $TPRM_importer_restricted_fields ){
	return array_merge( $TPRM_importer_restricted_fields, array( 'user_group' ) );
}

function TPRM_importer_wpug_documentation_after_plugins_activated(){
	?>
	<tr valign="top">
...
function TPRM_importer_wpug_post_import_single_user( $headers, $row, $user_id ){
