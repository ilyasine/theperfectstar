...
class TPRM_importer_WCF{
	...
	function get_fields(){
  	...
  	function documentation(){
		?>
		<tr valign="top">
			<th scope="row"><?php _e( "WooCommerce Custom Fields is activated", 'kwf-importer' ); ?></th>
			<td>
				<?php _e( "You can import those fields, look at fields you can import using the column names shown below.", 'kwf-importer' ); ?>.
	...
	function restricted_fields( $TPRM_importer_restricted_fields ){
		return array_merge( $TPRM_importer_restricted_fields, array_keys( $this->get_fields() ) );
	}
