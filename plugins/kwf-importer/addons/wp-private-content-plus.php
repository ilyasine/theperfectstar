...
class TPRM_importer_WP_Private_Content_Plus{
	...
	function restricted_fields( $TPRM_importer_restricted_fields ){
		return array_merge( $TPRM_importer_restricted_fields, array( 'wp_private_content_plus_groups' ) );
	}
...
$TPRM_importer_wp_private_content_plus = new TPRM_importer_WP_Private_Content_Plus();
$TPRM_importer_wp_private_content_plus->bootstrap();