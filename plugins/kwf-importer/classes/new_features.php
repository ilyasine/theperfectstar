...
class TPRM_importer_NewFeatures{
	public static function message(){
		?>
<div class="postbox">
    <h3 class="hndle"><span>&nbsp;<?php _e( 'New features', 'kwf-importer' ); ?></span></h3>

    <div class="inside" style="display: block;">
        <p><?php _e( 'This is a list of new features that we want to include, but we have not been able to do yet. We have a bussiness and have not so much time for this plugin as we would like to have. If you need some new feature not included in this list, please write us to:', 'kwf-importer' ); ?> <a href="mailto:contacto@codection.com">contacto@codection.com</a>. <?php _e( 'You can also donate us or talk with us to have some of the next new features done soon.', 'kwf-importer' ); ?></p>
