...
class TPRM_importer_MetaKeys{
	public static function admin_gui(){
		$meta_keys_obj = new TPRM_importer_MetaKeys_Table();
	?>
	<style type="text/css">
		.tablenav.top{
			display: none;
	...
	<h3><?php _e( 'Meta keys used in your database for users', 'kwf-importer' ); ?></h3>
	<div id="poststuff">
...
class TPRM_importer_MetaKeys_Table extends WP_List_Table {
