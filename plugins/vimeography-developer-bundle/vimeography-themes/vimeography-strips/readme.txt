...
Strips uses prominent thumbnail and caption strips to draw attention to your best videos.
...
1. Upload `vimeography-strips.zip` to the `/wp-content/plugins/` directory
...
= 2.0 =
* Rewrote the Strips theme for Vimeography 2 compatibility.
...
* Set the fancybox content manually instead of using an iframe helper
...
= 1.0.5 =
* Moved Fancybox dependency into the Strips theme
