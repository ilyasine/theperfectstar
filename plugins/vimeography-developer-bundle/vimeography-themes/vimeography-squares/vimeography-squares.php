<?php
/*
Plugin Name: Vimeography Theme: Squares
Plugin URI: https://vimeography.com/themes
Theme Name: Squares
Theme URI:  https://vimeography.com/themes/squares
Version: 2.2.2
Description: Squares displays a thumbnail quilt containing details about your video.
Author: Dave Kiss
Author URI: https://vimeography.com
Copyright: 2020 Dave Kiss
*/

if ( ! class_exists('Vimeography_Themes_Squares') ) {

  class Vimeography_Themes_Squares {
  ...
  new Vimeography_Themes_Squares;
}