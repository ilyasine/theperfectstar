 ...
 */
  $settings = array(
    array(
      ...
      'properties' =>
        array(
          array('target' => '.vimeography-theme-coast .vimeography-thumbnail-container .vimeography-link img', 'attribute' => 'borderColor'),
        )
    ),
    array(
      'type'       => 'colorpicker',
      ...
      'properties' =>
        array(
          array('target' => '.vimeography-theme-coast .vimeography-thumbnail-container .vimeography-link.vimeography-link-active img', 'attribute' => 'borderColor'),
        )
    ),
    array(
      'type'       => 'colorpicker',
      ...
      'properties' =>
        array(
          array('target' => '.vimeography-theme-coast .vimeography-player:before', 'attribute' => 'borderTopColor'),
        )
    ),
    array(
      'type'       => 'colorpicker',
      'label'      => __('Paging Arrow Color'),
      'id'         => 'paging-arrow-color',
      'value'      => '#1b4cd8',
      'pro'        => false,
      'namespace'  => true,
      'properties' =>
        array(
          array('target' => '.vimeography-theme-coast .swiper-button-prev', 'attribute' => 'color'),
          array('target' => '.vimeography-theme-coast .swiper-button-next', 'attribute' => 'color'),
        )
    ),
    array(
      'type'       => 'numeric',
      'label'      => __('Max Player Size'),
      'id'         => 'max-player-size',
      'value'      => '800',
      'min'        => '640',
      'max'        => '1920',
      ...
      'properties' =>
        array(
          array('target' => '.vimeography-modal .vimeography-plain-old-player', 'attribute' => 'maxWidth'),
        )
    ),
    array(
      'type'       => 'visibility',
      ...
      'properties' =>
        array(
          array('target' => '.vimeography-theme-coast .vimeography-title', 'attribute' => 'display'),
        )
    ),
  );