...
class Endpoint {
	...
	public static function get_default_loop_filter_fields_token() {
		...
		return array(
			'ITEM_NOT_EMPTY' => array(
				'type'     => 'select',
				'value'    => 'is_not_empty',
				'readable' => _x( 'Current item is not empty', 'General', 'uncanny-automator-pro' ),
				'backup'   => array(
	...
	public static function get_default_loop_filter_backup_token() {
		...
		return array(
			...
			'sentence'         => 'The item in the loop meets {{a specific condition:ITEM_NOT_EMPTY}}',
			'sentence_html'    => '&lt;span class=&quot;sentence sentence--standard&quot;&gt;&lt;span class=&quot;sentence-plain&quot;&gt;The item in the loop meets &lt;/span&gt;&lt;span class=&quot;sentence-pill&quot; size=&quot;small&quot; filled=&quot;&quot;&gt;&lt;span class=&quot;sentence-pill-label&quot;&gt;Condition: &lt;/span&gt;&lt;span class=&quot;sentence-pill-value&quot;&gt;Current item is not empty&lt;/span&gt;&lt;/span&gt;&lt;/span&gt;',
		);
