...
class WPF_WPForms extends WPForms_Provider {
	...
	public function output_fields( $connection_id = '', $connection = array(), $form = '' ) {
		...
		$output = '<div class="wpforms-provider-fields wpforms-connection-block" style="' . ( isset( $connection['options']['main_form_fields'] ) && $connection['options']['main_form_fields'] ? '' : 'display: none;' ) . '">';
