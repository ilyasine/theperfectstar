...
class WPF_User {
	...
	public function __construct() {
		...
		// Roles.
		add_filter( 'wp_pre_insert_user_data', array( $this, 'set_inserting_user_flag' ) );
	 ...
	 */
	public function set_inserting_user_flag( $user_data ) {
	...
	public function add_remove_user_role( $user_id, $role ) {
		...
		if ( $this->inserting_user || doing_action( 'set_current_user' ) || doing_wpf_webhook() ) {
