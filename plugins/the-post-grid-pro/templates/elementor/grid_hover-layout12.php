...
<?php if ( $tpg_post_count == 1 || $tpg_post_count == 2 ) : ?>
    ...
    <div class="rt-col-xs-12 <?php echo esc_attr( 1 == $tpg_post_count ? 'rt-col-md-7 rt-col-sm-6 offset-left-wrap offset-left ' . implode( ' ', $column_classes )
		: 'rt-col-md-5 rt-col-sm-6 offset-right' ); ?>">
<?php endif; ?>
