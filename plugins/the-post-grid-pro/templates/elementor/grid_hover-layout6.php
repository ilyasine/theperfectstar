...
<?php if ( $tpg_post_count == 1 || $tpg_post_count == 2 ) : ?>
    ...
    <div class="rt-col-xs-12 <?php echo esc_attr( 1 == $tpg_post_count ? 'rt-col-md-6 rt-col-sm-6 offset-left-wrap offset-left ' . $column_classes
		: 'rt-col-md-6 rt-col-sm-6 offset-right' ); ?>">
<?php endif; ?>

<?php if ( $tpg_post_count == 2 ) { ?>
    <!--Start .rt-row -->
    <div class='rt-row rt-row-inner'>
    <div class="rt-col-xs-12 <?php echo esc_attr( $column_classes ); ?>" data-id="<?php echo esc_attr( $pID ); ?>">
<?php } ?>

<?php if ( $tpg_post_count > 2 ){ ?>
    <!--Start right offset column -->
    <div class="<?php echo esc_attr( $col_class . ' ' . $column_classes ); ?>" data-id="<?php echo esc_attr( $pID ); ?>">
<?php } ?>
