...
if ( $postCount % 3 == 0 ) :
	$html        .= "<div class='rt-col-lg-7 rt-col-md-6 rt-col-sm-12 {$class}' data-id='{$pID}'>";
	...
	if ( $postCount % 3 == 1 ) {
		...
		$html          .= "<div class='rt-col-lg-5 rt-col-md-6 rt-col-sm-12'><div class='rt-row rt-gutter-5'>";
	}

	$html        .= "<div class='rt-col-xs-12 {$class}' data-id='{$pID}'><div class='rt-post-overlay rt-post-overlay-md layout-3'>";
	$contentHtml .= $imgHtml;
	$contentHtml .= '<div class="post-content">';
