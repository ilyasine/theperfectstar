...
$imgSrc  = ( $postCount % 5 ) == 0 ? $imgSrc : $smallImgSrc;
...
if ( $postCount % 5 == 0 ) :
	$html        .= "<div class='rt-col-lg-4 rt-col-md-6 rt-col-sm-12 big-layout {$class}' data-id='{$pID}'>";
	...
	if ( $postCount % 5 == 1 ) {
		$colSet        = true;
		$rightSideGrid = 12 - $desktopGrid;
		$html          .= "<div class='rt-col-lg-8 rt-col-md-6 rt-col-sm-12 small-layout'><div class='rt-row rt-gutter-5'>";
	}

	$html        .= "<div class='rt-col-lg-6 rt-col-sm-6 rt-col-xs-12 {$class}' data-id='{$pID}'><div class='rt-post-overlay rt-post-overlay-md layout-3'>";
	$contentHtml .= $imgHtml;
	$contentHtml .= '<div class="post-content">';
