...
if ( $_product->is_purchasable() ) {
	if ( $_product->is_in_stock() ) {
		$button = "<div><a href='{$pLink}?add-to-cart={$pID}' class='rt-wc-add-to-cart' data-id='{$pID}' data-type='{$_product->get_type()}'>" . esc_html__( 'Add To Cart', 'the-post-grid-pro' ) . '</a></div>';
	}
}
