...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'tprm-theme' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'tprm-theme' );
...
<div class="quantity <?php echo $is_readonly ? 'quantity--readonly' : ''; ?>">
	...
	<div class="bs-quantity">
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'tprm-theme' ); ?>"
			size="4"
