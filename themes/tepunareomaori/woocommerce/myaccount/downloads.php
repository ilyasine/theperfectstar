...
<div class="wc-MyAccount-sub-heading">
    <h2><?php _e( 'Downloads', 'tprm-theme' ); ?></h2>
</div>
...
<div class="wc-MyAccount-inner-content">
	...
	<?php else : ?>
		<div class="woocommerce-Message woocommerce-Message--info woocommerce-info wc-MyAccount-fix-center">
			...
			<div class="wc-MyAccount-sub-tagline"><?php esc_html_e( 'No downloads available yet.', 'tprm-theme' ); ?></div>
			<a class="woocommerce-Button button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>">
				<?php esc_html_e( 'Go shop', 'tprm-theme' ) ?>
			</a>
		</div>
	<?php endif; ?>
