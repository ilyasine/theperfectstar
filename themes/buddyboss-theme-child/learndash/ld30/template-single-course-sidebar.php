    ...
    <div class="bb-ld-sticky-sidebar">
        <div class="widget bb-enroll-widget">
            ...
            <div class="bb-course-preview-content">
				...
				if ( sizeof( $lesson_count ) > 0 || $topics_count > 0 || $course_quizzes_count > 0 || $course_certificate || $course_duration ) { ?>
                    ...
                    <ul class="bb-course-volume-list">
						...
						<?php if ( $course_duration ) { ?>
                            <li>
                                <i class="bb-icons bb-icon-clock"></i><?php echo $course_duration; ?> </li>
						<?php } ?>
                    </ul>
                    </div><?php
				} ?>
